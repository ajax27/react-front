  ...
  signupForm = (name, email, password, recaptcha) => (
    <form>
      ...
      <button
        ...
        className="btn btn-raised btn-primary border border-secondary">
        Submit
      </button>
    </form>
  );
  ...
  render() {
    ...
    return (
      <div className="container">
        <h2 style={{ fontWeight: 'bold' }} className="mt-5 mb-5">Sign Up</h2>
        <hr />
        <SocialLogin />
        <hr />
        <br />
        ...
        <div
          ...
          Congratulations, Welcome to your new account!<br />
